...
// Optional: if you don't want SSG for this page, uncomment the next line
// export const dynamic = "force-dynamic";

export default function CartPage() {
  return (
    <Suspense fallback={<div className="max-w-2xl mx-auto p-4">Loading cart…</div>}>
      <CartInner />
    </Suspense>
  );
}
...
function CartInner() {
  ...
  const totalCents = useCart((s) => s.totalCents)(); // keep your current selector shape
